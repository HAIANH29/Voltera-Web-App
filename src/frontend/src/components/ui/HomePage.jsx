  ...
  const faqItems = [
    {
      ...
      answer:
        "Typical delivery takes 3-7 business days depending on your location and the vehicle's current status. Express delivery options are available for premium listings.",
    },
    {
      question: "How to claim insurance?",
      answer:
        "All vehicles come with transfer documentation. Contact our insurance partners for seamless coverage transfer, or we can help you find competitive rates from our network.",
    },
    {
      question: "Can I request people working?",
      answer:
        "Yes, our certified technicians can perform pre-delivery inspections, battery health checks, and basic maintenance to ensure your EV is road-ready upon delivery.",
    },
  ];
              ...
              <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-semibold mb-2">
                    Join Voltera Community
                  </h3>
                  <p className="text-muted-foreground">
                    Access personalized dashboards based on your role in the
                    marketplace
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-6 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Browse vehicles, save favorites, track purchases, and get
                  ...
                  <div className="text-center p-6 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Create listings, manage inventory, track sales, and
                  ...
                  <div className="text-center p-6 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Manage users, moderate listings, handle disputes, and view
                      analytics
                    </p>
                    <button
                      onClick={() => onNavigate("login")}
      ...
      <div className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl mb-6">
            Ready to Find Your Perfect Electric Vehicle?
          </h2>
