...
export default function ContractPage() {
    ...
    return {
      ...
      vehicle: {
        ...
        batterycapacityDisplay:
          batteryCapacity != null ? `${batteryCapacity} kWh` : "Not specified",
        ...
        vehicleinspection:
          vehicleInspection != null ? vehicleInspection : false,
      },
    };
  };
  ...
  const mapBatteryData = (postData) => {
    ...
    return {
      ...
      battery: {
        ...
        originCapacityDisplay:
          b?.originCapacity != null
            ? `${b.originCapacity} kWh`
            : "Not specified",

        remainingCapacity:
          b?.remainingCapacity != null ? b.remainingCapacity : null,
        ...
        mileageCoveredDisplay:
          b?.mileageCovered != null ? `${b.mileageCovered} km` : "New battery",

        warranty: b?.warranty || "No warranty information",
        weight: b?.weight != null ? `${b.weight} kg` : "Not specified",
        lifeCycle:
          b?.lifeCycle != null ? `${b.lifeCycle} cycles` : "Not specified",
  ...
  return (
    <div className="contract-page">
                    ...
                    {contracts.map((contract) => (
                      <tr key={contract.contractId}>
                        ...
                        <td className="signed-status">
                          <div>
                            BUYER: {contract.signedByBuyer ? "✅" : "❌"}{" "}
                            SELLER: {contract.signedBySeller ? "✅" : "❌"}
                          </div>
                        </td>
      ...
      {viewingContract && (
        <div
          className="contract-detail-section"
          key={`contract-${viewingContract}`}
        >
          <ContractPreview
          ...
          <div
            ...
            key={`info-${viewingContract}-${
              batteryDetail ? "battery" : "vehicle"
            }`}
          >
              ...
              {loadingVehicle ? (
                <div className="loading-state">
                  ...
                  <div className="loading-text">
                    Loading{" "}
                    {batteryDetail || contractType === "battery"
                      ? "battery"
                      : "vehicle"}{" "}
                    details...
                  </div>
                ...
                <div className="battery-details-grid">
                  <div className="battery-basic-info">
                    ...
                    <div className="info-grid">
                      ...
                      <div className="info-item">
                        ...
                        <span className="value">
                          $
                          {batteryDetail.price?.toLocaleString() ||
                            "Contact for price"}
                        </span>
                      </div>
                      <div className="info-item">
                    ...
                    <div className="battery-specs-info">
                      ...
                      <div className="specs-grid">
                        <div className="spec-item">
                          ...
                          <span className="value">
                            {batteryDetail.battery.batteryType || "N/A"}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Serial Number:</span>
                          <span className="value">
                            {batteryDetail.battery.serialNumber}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Original Capacity:</span>
                          <span className="value">
                            {batteryDetail.battery.originCapacityDisplay}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Remaining Capacity:</span>
                          <span className="value">
                            {batteryDetail.battery.remainingCapacityDisplay}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Voltage:</span>
                          <span className="value">
                            {batteryDetail.battery.voltageDisplay}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Cycle Count:</span>
                          <span className="value">
                            {batteryDetail.battery.cycleCount}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Mileage Covered:</span>
                          <span className="value">
                            {batteryDetail.battery.mileageCoveredDisplay}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Warranty:</span>
                          <span className="value">
                            {batteryDetail.battery.warranty}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Weight:</span>
                          <span className="value">
                            {batteryDetail.battery.weight}
                          </span>
                        </div>
                        <div className="spec-item">
                          <span className="label">Life Cycle:</span>
                          <span className="value">
                            {batteryDetail.battery.lifeCycle}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Battery Images */}
                  {batteryDetail.imageUrls &&
                    batteryDetail.imageUrls.length > 0 && (
                ...
                <div className="vehicle-details-grid">
                  <div className="vehicle-basic-info">
                    ...
                    <div className="info-grid">
                      ...
                      <div className="info-item">
                        ...
                        <span className="value">
                          $
                          {vehicleDetail.price?.toLocaleString() ||
                            "Contact for price"}
                        </span>
                      </div>
                      <div className="info-item">
                    ...
                    <div className="vehicle-specs-info">
                      ...
                      <div className="specs-grid">
                        ...
                        <div className="spec-item">
                          ...
                          <span className="value">
                            {vehicleDetail.vehicle.color || "N/A"}
                          </span>
                        </div>
                        <div className="spec-item">
                        ...
                        <div className="spec-item">
                          ...
                          <span className="value">
                            {vehicleDetail.vehicle.style || "N/A"}
                          </span>
                        </div>
                        <div className="spec-item">
                        ...
                        <div className="spec-item">
                          ...
                          <span className="value">
                            {vehicleDetail.vehicle.vehicleinspection
                              ? "Yes"
                              : "No"}
                          </span>
                        </div>
                  ...
                  {/* Vehicle Images */}
                  {vehicleDetail.imageUrls &&
                    vehicleDetail.imageUrls.length > 0 && (
                    ...
                    {batteryDetail && vehicleDetail
                      ...
                      : `No ${
                          batteryDetail
                            ...
                            ? "vehicle"
                            : "contract"
                        } data available. Contract may not have postId or data is still loading.`}
                  </p>
                </div>
              )}
            </div>
