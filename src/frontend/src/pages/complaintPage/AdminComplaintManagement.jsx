...
const AdminComplaintManagement = () => {
  ...
  const searchComplaints = async (problem) => {
    ...
    try {
      ...
      const response = await api.get(
        `/api/reply-complaint/search?problem=${encodeURIComponent(problem)}`
      );
  ...
  const filteredComplaints = getCurrentComplaints().filter(
    (complaint) =>
                          ...
                          <div className="user-cell">
                            ...
                            <div>
                              <div className="username">
                                {complaint.userId?.username || "Unknown"}
                              </div>
                              <div className="email">
                ...
                <div className="complaint-info">
                  <div className="info-grid">
                    ...
                    <div className="info-item">
                      <label>User:</label>
                      <span>
                        {selectedComplaint.userId?.username} (
                    ...
                    <div className="info-item">
                      <label>Date:</label>
                      <span>
                        {new Date(selectedComplaint.createAt).toLocaleString()}
                      </span>
                    </div>
                  </div>
