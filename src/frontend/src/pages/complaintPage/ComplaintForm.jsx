            ...
            <form onSubmit={handleSubmit} className="complaint-form">
              ...
              <div className="tips-section">
                ...
                <ul>
                  ...
                  <li>
                    Describe what you were trying to do when the issue happened
                  </li>
                  <li>
                    Include screenshots if helpful (you can attach them after
                    submission)
                  </li>
                </ul>
              </div>
            ...
            <div className="help-options">
              <div className="help-option">
                ...
                <div className="help-content">
                  <h4>Phone Support</h4>
                  <p>
                    Call us at: <strong>1800-VOLTERA</strong>
                  </p>
